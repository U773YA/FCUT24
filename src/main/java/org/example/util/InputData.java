...
//        playerCardInputList.add(new CardInput(19915, 50558911, "SMITH CENTURIONS ICON", 90));

        playerCardInputList.add(new CardInput(37, 192985, "DE BRUYNE", 91));
...
//        playerCardInputList.add(new CardInput(19654, 50512578, "DZEKO RTTK", 90));
        ...
        playerCardInputList.add(new CardInput(46, 227361, "DIANI", 89));
...
//        playerCardInputList.add(new CardInput(49, 231866, "RODRI", 89));
        ...
        playerCardInputList.add(new CardInput(20259, 67319799, "BERARDI TOTW", 88));
//        playerCardInputList.add(new CardInput(19646, 67293208, "BONUCCI RTTK", 88));
        playerCardInputList.add(new CardInput(69, 212198, "BRUNO FERNANDES", 88));
        ...
        playerCardInputList.add(new CardInput(20225, 50545314, "LOFTUS-CHEEK THUNDERSTRUCK", 88));
//        playerCardInputList.add(new CardInput(20210, 84078585, "LUKAKU THUNDERSTRUCK", 88));
        playerCardInputList.add(new CardInput(20169, 50563095, "MALEN FC PRO", 88));
        playerCardInputList.add(new CardInput(20089, 50596900, "NEVILLE", 88));
        playerCardInputList.add(new CardInput(231, 200389, "OBLAK", 88));
        playerCardInputList.add(new CardInput(441, 232293, "OSIMHEN", 88));
...
//        playerCardInputList.add(new CardInput(106, 226302, "POPP", 88));
        ...
        playerCardInputList.add(new CardInput(20804, 50556070, "BOGA STORYLINE", 87));
...
//        playerCardInputList.add(new CardInput(953302, 223197, "UNAL CENTURIONS EVO", 87, "2-17"));
        playerCardInputList.add(new CardInput(20824, 50517794, "WELBECK FLASHBACK", 87));
...
//        playerCardInputList.add(new CardInput(404, 237197, "GEYORO", 86));
        playerCardInputList.add(new CardInput(20263, 67354016, "GIMENEZ TOTW", 86));
...
//        playerCardInputList.add(new CardInput(228, 182521, "KROOS", 86));
        playerCardInputList.add(new CardInput(19754, 67301369, "LUKAKU TOTW", 86));
...
//        playerCardInputList.add(new CardInput(239, 224334, "ACUNA", 85));
        playerCardInputList.add(new CardInput(242, 197445, "ALABA", 85));
...
//        playerCardInputList.add(new CardInput(78, 206517, "GREALISH", 85));
...
//        playerCardInputList.add(new CardInput(173, 226753, "ONANA", 85));
        playerCardInputList.add(new CardInput(2512, 246629, "OSHOALA", 85));
        playerCardInputList.add(new CardInput(20831, 67349814, "PEDRO GONCALVES TOTW", 85));
        playerCardInputList.add(new CardInput(388, 226328, "RAPINOE", 85));
        playerCardInputList.add(new CardInput(82, 231677, "RASHFORD", 85));
...
//        playerCardInputList.add(new CardInput(168, 262330, "CATARINA MACARIO", 84));
//        playerCardInputList.add(new CardInput(20269, 50583400, "CHEVALIER TOTW", 84));
        playerCardInputList.add(new CardInput(24, 235805, "CHIESA", 84));
...
//        playerCardInputList.add(new CardInput(2520, 241084, "DIAZ", 84));
...
//        playerCardInputList.add(new CardInput(241, 225193, "MERINO", 84));
...
//        playerCardInputList.add(new CardInput(164, 258980, "RUSSO", 84));
...
//        playerCardInputList.add(new CardInput(20842, 50553489, "ARMSTRONG TOTW", 83));
...
//        playerCardInputList.add(new CardInput(20786, 50561553, "BARDAKCI TOTW", 83));
...
//        playerCardInputList.add(new CardInput(319, 208333, "CAN", 83));
        playerCardInputList.add(new CardInput(42104284, 208333, "CAN EVOLUTIONS III", 87, "72"));
...
//        playerCardInputList.add(new CardInput(482, 245882, "CUTHBERT", 83));
        ...
        playerCardInputList.add(new CardInput(320, 234396, "DAVIES", 83));
...
//        playerCardInputList.add(new CardInput(345, 226998, "ERIKSSON", 83));
        ...
        playerCardInputList.add(new CardInput(22, 247090, "FERNANDEZ", 83));
...
//        playerCardInputList.add(new CardInput(365, 233756, "JANSSEN", 83));
...
//        playerCardInputList.add(new CardInput(20839, 50582659, "KIRIAN TOTW", 83));
...
//        playerCardInputList.add(new CardInput(196, 241023, "LUDMILA", 83));
...
//        playerCardInputList.add(new CardInput(20728, 67349834, "PAYERO TOTW", 83));
        playerCardInputList.add(new CardInput(514, 228251, "PELLEGRINI", 83));
...
//        playerCardInputList.add(new CardInput(518, 225659, "RODRIGUEZ", 83));
        playerCardInputList.add(new CardInput(20838, 50539201, "ROHDEN TOTW", 83));
...
//        playerCardInputList.add(new CardInput(528, 263011, "TOONE", 83));
        ...
        playerCardInputList.add(new CardInput(20898, 50595535, "URBIG TOTW", 83));
...
//        playerCardInputList.add(new CardInput(576, 233486, "LE NORMAND", 82));
...
//        playerCardInputList.add(new CardInput(430, 214097, "BOURIGEAUD", 81));
...
//        playerCardInputList.add(new CardInput(684, 264971, "KAMCZYK", 81));
