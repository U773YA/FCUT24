...
public class InputData {
    ...
    protected static long chemistryCap = 29;
    protected static List<Integer> mandatoryPlayers = List.of(19261);
...
//        managerList.add(new Manager("A. SOTTIL", "Italy", 31));
        managerList.add(new Manager("B. RODGERS", "Northern Ireland", 50));
        managerList.add(new Manager("C. TEVEZ", "Argentina", 353));
        managerList.add(new Manager("FILIPA PATAO", "Portugal", 2228));
        managerList.add(new Manager("FILIPE MARTINS", "Portugal", 308));
...
//        managerList.add(new Manager("JAGOBA ARRASATE", "Spain", 53));
        managerList.add(new Manager("J. NEESTRUP", "Denmark", 1));
...
//        managerList.add(new Manager("JORGE JESUS", "Portugal", 350));
        ...
        managerList.add(new Manager("J. VACCARI", "Argentina", 1014));
...
//        managerList.add(new Manager("R. PALLADINO", "Italy", 31));
        managerList.add(new Manager("R. SCHMIDT", "Germany", 308));
        managerList.add(new Manager("R. VIDOSIC", "Croatia", 351));
        managerList.add(new Manager("R. VILAHAMN", "Sweden", 2216));
//        managerList.add(new Manager("SERGIO", "Spain", 53));
        ...
        managerList.add(new Manager("W. KIRK", "Scotland", 2216)); // Womens Eng1
